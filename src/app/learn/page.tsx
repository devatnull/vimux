        ...
        <div className="flex-1 flex flex-col pt-16">
          ...
          <div className="bg-[#24283b] border-b border-[#414868] px-2 md:px-4 py-2 flex items-center gap-2 md:gap-4">
            ...
            <button
              ...
              className="p-1 rounded hover:bg-[#414868] text-[#565f89] hover:text-[#a9b1d6] hidden sm:block"
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 md:gap-3">
                ...
                <h1 className="text-[#c0caf5] font-medium text-sm md:text-base truncate">{selectedLesson.title}</h1>
                {isComplete && <CheckCircle className="w-4 h-4 text-[#9ece6a] flex-shrink-0" />}
              </div>
            </div>
          ...
          <div className="flex-1 flex relative">
            ...
            {showLessonList && (
              <>
                ...
                />
                <div className="fixed md:absolute left-0 top-0 bottom-0 w-full sm:w-80 bg-[#1a1b26] border-r border-[#414868] z-20 overflow-y-auto">
                  <div className="p-4">
                    <div className="flex items-center justify-between mb-4 md:hidden">
                      <span className="text-[#c0caf5] font-medium">Lessons</span>
                      <button
                        onClick={() => setShowLessonList(false)}
                        className="p-2 rounded hover:bg-[#414868] text-[#565f89]"
                      >
                        <X className="w-5 h-5" />
                      </button>
                    </div>
          ...
          <div className="bg-[#24283b] border-t border-[#414868] sticky bottom-0 z-10">
            ...
            <div className="px-2 md:px-4 py-2 md:py-3 flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                  ...
                  {currentStep.expectedKeys && currentStep.expectedKeys.length > 0 && (
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      {(currentStep.expectedKeys ?? []).map((key, i) => (
                        <span key={i} className="key text-xs">
              ...
              {feedback && (
                <div
                  className={clsx(
                    "px-2 md:px-3 py-1 rounded text-xs md:text-sm",
              ...
              <div className="flex items-center gap-2">
                ...
                {isLastStep ? (
                  <button
                    ...
                    className="px-3 md:px-4 py-2 text-xs md:text-sm rounded bg-[#9ece6a] text-[#1a1b26] font-medium hover:bg-[#b9db84] transition-colors"
                  >
                  ...
                  <button
                    onClick={() => nextStep()}
                    className="px-3 md:px-4 py-2 text-xs md:text-sm rounded bg-[#414868] text-[#a9b1d6] hover:bg-[#565f89] transition-colors"
                  >
                    Skip →
                  </button>
                )}
